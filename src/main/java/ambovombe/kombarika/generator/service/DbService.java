...
public class DbService {
  ...
  public static String formatString(String column) {
    ...
    if (splited.length < 2) return column;
  ...
  public static HashMap<String, String> getColumnNameAndType(Connection con, String tableName)
      throws Exception {
  ...
  public static HashMap<String, String> getDetailsColumn(Connection con, String tableName)
      throws Exception {
    HashMap<String, String> map = new HashMap<>();
  ...
  ////            for(int i = 1; i <= count; i++){
  //                System.out.println(" column NAME = " + rsmd.getColumnName(4) + " column VALUES =
  // "+primaryKeys.getObject("column_name") + " column TYPE = " + rsmd.getColumnClassName(4));
  ////            }
  //        }
  //    }

  public static List<String> getPrimaryKey(DbConnection dbConnection, String tableName)
      throws Exception {
    String query =
        dbConnection
            .getListConnection()
            .get(dbConnection.getInUseConnection())
            .getDatabaseType()
            .getPrimaryKeyQuery();
    ...
    while (rs.next()) listPrimaryKeys.add(rs.getString(1));
    return listPrimaryKeys;
  }

  public static HashMap<String, String> getForeignKeys(DbConnection dbConnection, String tableName)
      throws Exception {
    String query =
        dbConnection
            .getListConnection()
  ...
  public static List<String> getPrimaryKeyType(DbConnection dbConnection, String tableName)
      throws Exception {
  ...
  //                 System.out.println(" column NAME = " + rsmd2.getColumnName(i) + " column VALUES
  // = " + foreignKeys.getString(i) + " column TYPE = "+rsmd2.getColumnClassName(i));
  //             }
  //             System.out.println("-------------------------------------");
  //         }
  // //        return map;
