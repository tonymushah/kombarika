...
public class Controller {
  ...
  public String save(String table) {
    ...
    args +=
        this.getLanguageProperties()
                .getAnnotationSyntax()
                .replace("?", this.getControllerProperty().getAnnotationArgumentParameterFormData())
            + " "
  ...
  public String findAll(
      String table, HashMap<String, String> columns, HashMap<String, String> foreignKeys) {
    String body = "";
    body +=
        Misc.tabulate(
            this.getCrudMethod()
  ...
  public String getCrudMethods(String table) throws Exception {
    ...
    HashMap<String, String> columns =
        DbService.getDetailsColumn(this.getDbConnection().getConnection(), table);
    ...
    if (!this.getControllerProperty().getField().equals("")
      ...
      res +=
          "\t"
              + this.getLanguageProperties()
                  .getAnnotationSyntax()
                  .replace("?", this.getControllerProperty().getAnnotationField())
              + "\n"
              + "\t"
              + this.getControllerProperty()
                  .getField()
                  ...
                  .replace(
                      "#name#",
                      ObjectUtility.capitalize(ObjectUtility.formatToCamelCase(repository)))
              + "\n";
  ...
  public String getControllerClass(String table, String framework) {
    ...
    res =
        res.replace("?", ObjectUtility.formatToCamelCase(table))
            + "\n"
            + this.getLanguageProperties().getClassSyntax()
            + " "
            + ObjectUtility.capitalize(
                ObjectUtility.formatToCamelCase(
                        this.getLanguageProperties()
                            .getFrameworks()
                            .get(framework)
  ...
  public String getControllerImport(String repository, String entity, String table)
      throws Exception {
    String res = "";
    String imp = this.getLanguageProperties().getImportSyntax();
    for (String item : this.getImports().getController()) {
      item =
          item.replace("packageName", repository)
              .replace(
                  "className", ObjectUtility.capitalize(ObjectUtility.formatToCamelCase(table)))
