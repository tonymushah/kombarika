...
public class View {
            ...
            template
                    ...
                    .replace(
                        ...
                        this.getViewProperties()
                            ...
                            .get(
                                set.getValue()
                                    .split("\\.")[set.getValue().split("\\.").length - 1]))
  ...
  public String getOptionUpdate(
      HashMap<String, String> foreignKeys, String url, String id, String attribute, String table)
      throws Exception {
    String res = "";
    ...
    for (Map.Entry<String, String> set : foreignKeys.entrySet()) {
      res +=
          this.getViewProperties()
              ...
              .replace(
                  "#Name#",
                  ObjectUtility.capitalize(ObjectUtility.formatToCamelCase(set.getValue())))
        ...
        if (temp != null) {
          res +=
              this.getViewProperties()
                      ...
                      .replace("#id#", ObjectUtility.formatToCamelCase(id))
                      .replace(
                          "#Name#", ObjectUtility.capitalize(ObjectUtility.formatToCamelCase(temp)))
                      .replace(
                          "#optionUpdate#",
                          this.getOptionUpdate(foreignKeys, url, id, attribute, temp))
                  + "\n";
        } else {
          res +=
              template
                      ...
                      .replace(
                          "#Name#",
                          ObjectUtility.capitalize(ObjectUtility.formatToCamelCase(set.getKey())))
                      .replace("#name#", ObjectUtility.formatToCamelCase(set.getKey()))
                  + "\n";
        }
      } else {
  ...
  public String getHeaders(HashMap<String, String> columns) {
    ...
    for (Map.Entry<String, String> set : columns.entrySet()) {
      res +=
          "\t\t"
              + template.replace("#label#", ObjectUtility.formatToSpacedString(set.getKey()))
              + "\n";
    }
    return Misc.tabulate(Misc.tabulate(res));
  }
  ...
  public String getTableValue(
      HashMap<String, String> columns, HashMap<String, String> foreignKeys, String attribute) {
    String res = "";
      ...
      if (foreignKeys.get(set.getKey()) != null) {
        res +=
            "\t\t"
                + template.replace(
                    "#values#",
                    ObjectUtility.formatToCamelCase(foreignKeys.get(set.getKey()))
                        + "."
                        + ObjectUtility.formatToCamelCase(attribute))
                + "\n";
      } else {
        res +=
            "\t\t"
                + template.replace("#values#", ObjectUtility.formatToCamelCase(set.getKey()))
                + "\n";
      }
    }
  ...
  public String getHandleInputSelectChange(
      HashMap<String, String> columns,
      HashMap<String, String> foreignKeys,
      List<String> primaryKeys) {
    String res = "";
  ...
  public String getValues(
      HashMap<String, String> columns, HashMap<String, String> foreignKeys, String table) {
    String res = "";
    String template = this.getViewProperties().getValues();
    res +=
        template.replace("#entity#", table).replace("#Entity#", ObjectUtility.capitalize(table))
            + "\n";
    for (Map.Entry<String, String> set : columns.entrySet()) {
      String temp = foreignKeys.get(set.getKey());
      if (temp != null) {
        res +=
            this.getViewProperties()
                    ...
                    .replace(
                        "#Entity#", ObjectUtility.capitalize(ObjectUtility.formatToCamelCase(temp)))
                + "\n";
        continue;
      }
    }
  ...
  public String getFetcher(
    ...
    res += template.replace("#entity#", table).replace("#Entity#", ObjectUtility.capitalize(table));
    for (Map.Entry<String, String> set : columns.entrySet()) {
      String temp = foreignKeys.get(set.getKey());
      if (temp != null) {
        res +=
  ...
  public HashMap<String, String> getIdAndAttribute(
      DbConnection dbConnection, HashMap<String, String> foreignKeys) throws Exception {
    String attribute = "";
    String id = "";
    ...
    for (Map.Entry<String, String> set : foreignKeys.entrySet()) {
      ...
      HashMap<String, String> tempColumns =
          DbService.getDetailsColumn(dbConnection.getConnection(), set.getValue());
  ...
  public String generateRoutes(String[] tables) throws Exception {
    String res = "";
    if (this.getViewProperties().getRouteTemplate().equals("")) return res;
    String tempPath =
        Misc.getViewTemplateLocation()
            .concat(File.separator)
            .concat(this.getViewProperties().getRouteTemplate());
    res = FileUtility.readOneFile(tempPath);
    res =
        res.replace("${IMPORTS}", this.getImports(tables))
  ...
  public String generateMapping(String table, DbConnection dbConnection) throws Exception {
    ...
    HashMap<String, String> columns =
        DbService.getColumnNameAndType(dbConnection.getConnection(), table);
    String tempPath =
        Misc.getViewTemplateLocation()
            .concat(File.separator)
            .concat(this.getViewProperties().getMappingTemplate());
    res = FileUtility.readOneFile(tempPath);
    String fields = "";
    String imports = "";
    String temp = "";
      ...
      if (foreignKeys.get(set.getKey()) != null) {
        ...
        temp =
            this.getViewProperties()
                    .getMappingFieldSyntax()
                    .replace(
                        "#type#", this.getViewProperties().getListMapping().get(set.getValue()))
    ...
    return res.replace("#class#", ObjectUtility.capitalize(ObjectUtility.formatToCamelCase(table)))
  ...
  public String generateService(String table, String path) throws Exception {
    ...
    String tempPath =
        Misc.getViewTemplateLocation()
            .concat(File.separator)
            .concat(this.getViewProperties().getServiceTemplate());
    res = FileUtility.readOneFile(tempPath);
  ...
  public String generateServiceSpec(String table) throws Exception {
    ...
    String tempPath =
        Misc.getViewTemplateLocation()
            .concat(File.separator)
            .concat(this.getViewProperties().getServiceSpecTemplate());
    res = FileUtility.readOneFile(tempPath);
    String name = ObjectUtility.formatToCamelCase(table);
    res = res.replace("#name#", name).replace("#Name#", ObjectUtility.capitalize(name));
    return res;
  }
  ...
  public String generateComponentSpecs(String table) throws Exception {
    ...
    String tempPath =
        Misc.getViewTemplateLocation()
            .concat(File.separator)
            .concat(this.getViewProperties().getComponentSpecsTemplate());
    res = FileUtility.readOneFile(tempPath);
    String name = ObjectUtility.formatToCamelCase(table);
    res = res.replace("#name#", name).replace("#Name#", ObjectUtility.capitalize(name));
    return res;
  ...
  public String generateComponent(String table, DbConnection dbConnection) throws Exception {
    ...
    String tempPath =
        Misc.getViewTemplateLocation()
            .concat(File.separator)
            .concat(this.getViewProperties().getComponentTemplate());
    res = FileUtility.readOneFile(tempPath);
    HashMap<String, String> foreignKeys = DbService.getForeignKeys(dbConnection, table);
  ...
  public int checkStyle() {
    int res = 0;
    if (this.getViewProperties().getStyleTemplate().equals("")) return res;
    return 1;
  }
  ...
  public String generateView(String table, String url, DbConnection dbConnection) throws Exception {
    ...
    String tempPath =
        Misc.getViewTemplateLocation()
            .concat(File.separator)
            .concat(this.getViewProperties().getTemplate());
    ...
    HashMap<String, String> columns =
        DbService.getDetailsColumn(dbConnection.getConnection(), table);
    HashMap<String, String> foreignKeys = DbService.getForeignKeys(dbConnection, table);
    ...
    res =
        template
            .replace("#header#", getHeaders(columns))
            .replace(
                "#inputInsert#",
                getInputInsert(columns, foreignKeys, primaryKeys, url, id, attribute, table))
            .replace(
                "#inputUpdate#",
                getInputUpdate(columns, foreignKeys, primaryKeys, url, id, attribute))
            .replace(
                "#handleInputSelectChange#",
                getHandleInputSelectChange(columns, foreignKeys, primaryKeys))
