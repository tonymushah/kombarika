...
public class ObjectUtility {
  ...
  public static List<Integer> getUpperCaseIndex(String txt) {
    ...
    for (int i = 0; i < txt.length(); i++) {
      if (Character.isUpperCase(txt.charAt(i))) res.add(i);
    }
    return res;
  }
  ...
  public static String formatToCamelCase(String str) {
    ...
    if (splited.length < 2) return str;
  ...
  public static String fillZero(
      int length, int prefixLength, String num) { // Fill the zero Before the number
  ...
  public static boolean isAtDefaultValue(Method field, Object obj)
