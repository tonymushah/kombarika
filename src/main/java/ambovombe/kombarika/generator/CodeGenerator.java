...
public class CodeGenerator {
  ...
  public String buildEntity(String table, String packageName, String language, String framework)
      throws Exception {
  ...
  public void generateEntityFile(
      String path, String table, String packageName, String language, String framework)
      throws Exception {
    ...
    FileUtility.generateFile(
        path,
        GeneratorService.getFileNameCapitalized(table, languageProperties.getExtension()),
        entity);
  }

  public void generateEntity(String path, String table, String packageName, String lang)
      throws Exception {
    String[] splittedLang = lang.split(":");
    String language = splittedLang[0];
    String framework = splittedLang[1];
    this.setFrameworkProperties(
        this.getLanguageDetails().getLanguages().get(language).getFrameworks().get(framework));
  ...
  public String buildController(
    ...
    return controller.generateController(
        template, table, packageName, context, repository, entity, framework);
  }
  ...
  public void generateControllerFile(
    ...
    FileUtility.generateFile(
        path,
        GeneratorService.getFileNameCapitalized(
            table + this.getFrameworkProperties().getControllerProperty().getName(),
            languageProperties.getExtension()),
        content);
  }
  ...
  public void generateController(
    ...
    String framework = splittedLang[1];
    String controller =
        buildController(table, packageName, context, repository, entity, language, framework);
  ...
  public String buildRepository(
      String table, String packageName, String entityPackage, String language, String framework)
      throws Exception {
    LanguageProperties languageProperties = getLanguageDetails().getLanguages().get(language);
    FrameworkProperties frameworkProperties = languageProperties.getFrameworks().get(framework);
    TypeMapping typeMapping = getTypeProperties().getListProperties().get(language);
  ...
  public String buildRepository(
    ...
    repository.setLanguageProperties(languageProperties);
    repository.setTypeMapping(typeMapping);
    return repository.generateRepository(
        tables, context, packageName, entityPackage, primaryKeysType);
  }

  public void generateRepository(
      String path, String table, String packageName, String entityPackage, String lang)
      throws Exception {
    String[] splittedLang = lang.split(":");
    String language = splittedLang[0];
    String framework = splittedLang[1];
  ...
  public void generateRepository(
    ...
    String framework = splittedLang[1];
    String repository =
        buildRepository(tables, context, packageName, entityPackage, language, framework);
  ...
  public void generateView(String path, String table, String directory, String viewType, String url)
      throws Exception {
    String view = buildView(table, viewType, url);
    FileUtility.createDirectory(directory, path);
    path = path + File.separator + directory;
    String filename =
        GeneratorService.getFileName(
            table, this.getViewDetails().getViews().get(viewType).getExtension());
  ...
  public void generateRouter(String path, String viewType, String[] tables) throws Exception {
    ...
    String filename =
        GeneratorService.getFileName(
            this.getViewDetails().getViews().get(viewType).getRouteFilename(),
            this.getViewDetails().getViews().get(viewType).getRouteFileExtension());
  ...
  public void generateService(String path, String viewType, String table, String url)
      throws Exception {
  ...
  public void generateComponentSpecs(String path, String viewType, String table) throws Exception {
    ...
    if (componentSpec.equals("")) return;
    path = path + File.separator + ObjectUtility.formatToCamelCase(table);
    String filename =
        GeneratorService.getFileName(
            this.getViewDetails()
  ...
  public void generateAllEntity(
      String path, String[] tables, String packageName, String entity, String framework)
      throws Exception {
  ...
  public void generateAllRepository(
    ...
    if (this.getFrameworkProperties().isOneRepository()) {
      generateRepository(
          path,
          tables,
          ObjectUtility.capitalize(repository),
          packageName + "." + repository,
          entity,
          framework);
    } else {
      for (String table : tables) {
        generateRepository(
            path, table, packageName + "." + repository, packageName + "." + entity, framework);
      }
    }
  }

  public void generateAllView(
      String path, String[] tables, String view, String viewType, String url) throws Exception {
    for (String table : tables) {
  ...
  public void generateViewEnvironement(String path, String viewType, String projectName)
      throws Exception {
    String command =
        this.getViewDetails()
            .getViews()
